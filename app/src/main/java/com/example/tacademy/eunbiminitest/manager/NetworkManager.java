...
import com.example.tacademy.eunbiminitest.MyApplication;
import com.example.tacademy.eunbiminitest.data.FacebookFeed;
import com.example.tacademy.eunbiminitest.data.FacebookFeedsResult;
import com.example.tacademy.eunbiminitest.data.FacebookIdResult;
import com.example.tacademy.eunbiminitest.data.FacebookUploadResult;
...
import com.example.tacademy.eunbiminitest.data.TStoreCategoryProductResult;
import com.example.tacademy.eunbiminitest.data.TStoreCategoryResult;
...
public class NetworkManager {
    ...
    private NetworkManager(){
        ...
        CookieManager cookieManager = new CookieManager(new PersistentCookieStore(context), CookiePolicy.ACCEPT_ALL); //여기 쫌있다 인자로 클래스 2개 넘겨주기!
